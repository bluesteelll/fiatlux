package art.boyko.fiatlux.common.network;
        ...
        player.openMenu(
            new net.minecraft.world.SimpleMenuProvider(
                (containerId, inventory, playerEntity) -> {
                    ...
                    if (!(blockEntity instanceof art.boyko.fiatlux.server.blockentity.MechaGridBlockEntity mechaGrid)) {
                        return null;
                    }
                    ...
                    return new art.boyko.fiatlux.client.gui.ModuleMenu(containerId, inventory, 
