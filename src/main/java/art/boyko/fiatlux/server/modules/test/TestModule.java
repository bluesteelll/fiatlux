...
public class TestModule extends AbstractMechaModule {
    ...
    public void updateEnergyFromSync(int newEnergy) {
        this.energyStored = Math.max(0, Math.min(maxEnergy, newEnergy));
    ...
    public class TestEnergyProvider implements EnergyCapability.EnergyProvider {
        ...
        public int receiveEnergy(int maxReceive, boolean simulate) {
            ...
            if (!simulate && energyReceived > 0) {
                ...
                // No need for individual markForRenderUpdate calls - this reduces sync calls by ~95%
                // Rust ECS will automatically detect energy changes and batch them for efficient sync
            }
