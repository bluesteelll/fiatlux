...
public class ModuleScreen extends AbstractContainerScreen<art.boyko.fiatlux.client.gui.ModuleMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("fiatlux", "textures/gui/module_gui.png");
    
    public ModuleScreen(art.boyko.fiatlux.client.gui.ModuleMenu menu, Inventory playerInventory, Component title) {
